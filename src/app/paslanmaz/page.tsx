...
const PaslanmazPage: React.FC = () => {
  ...
  return (
    <div className="sub-products-container">
      <h1 className="sub-products-title">Paslanmaz Grubu</h1>
      <nav className="breadcrumb">
        <Link href="/">Anasayfa</Link> &gt; <Link href="/products">Ürünler</Link> &gt; <span>Paslanmaz</span>
      </nav>
