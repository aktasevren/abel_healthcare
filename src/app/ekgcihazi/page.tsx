...
function getSubProductsData(): SubProduct[] {
  ...
  return products
    .filter((product: any) => product.group_id === '4')
    .map((product: any) => ({
  ...
  return (
    <div className="sub-products-container">
      ...
      <nav className="breadcrumb">
        <Link href="/">Anasayfa</Link> &gt; <Link href="/products">Ürünler</Link> &gt; <span>EKG Cihazları</span>
      </nav>
